...
void main() {
  group('RdfMapperSourceBuilder Tests', () {
    ...
    test('buildExtensions returns correct mapping', () {
      ...
      expect(extensions['.rdf_mapper.cache.json'], equals(['.rdf_mapper.g.dart']));
    });
    ...
    test('build extensions configuration is correct', () {
      ...
      expect(extensions['.rdf_mapper.cache.json'], contains('.rdf_mapper.g.dart'));
    });
    ...
    test('builder has correct build extensions mapping', () {
      ...
      expect(builder.buildExtensions.keys.first, equals('.rdf_mapper.cache.json'));
      expect(builder.buildExtensions.values.first, equals(['.rdf_mapper.g.dart']));
    });
    ...
    Map<String, dynamic> _createValidCacheData() {
      return {
        ...
        'imports': ['package:rdf_mapper_annotations/rdf_mapper_annotations.dart'],
      };
    }
