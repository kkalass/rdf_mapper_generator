...
// Generated on: 2025-06-06T15:04:36.375026
...
class ClassWithIriNamedMapperStrategyMapper implements GlobalResourceMapper<ClassWithIriNamedMapperStrategy> {
  ...
  final IriTermMapper<lib84483435.ClassWithIriNamedMapperStrategy> _iriMapper;

  /// Constructor
  const ClassWithIriNamedMapperStrategyMapper({
    required IriTermMapper<lib84483435.ClassWithIriNamedMapperStrategy> iriMapper
...
class ClassWithIriMapperStrategyMapper implements GlobalResourceMapper<ClassWithIriMapperStrategy> {
  ...
  final IriTermMapper<lib84483435.ClassWithIriMapperStrategy> _iriMapper;

  /// Constructor
  const ClassWithIriMapperStrategyMapper({
    required IriTermMapper<lib84483435.ClassWithIriMapperStrategy> iriMapper
  }) : _iriMapper = iriMapper;
...
class ClassWithIriMapperInstanceStrategyMapper implements GlobalResourceMapper<ClassWithIriMapperInstanceStrategy> {
  ...
  final IriTermMapper<lib84483435.ClassWithIriMapperInstanceStrategy> _iriMapper;

  /// Constructor
  const ClassWithIriMapperInstanceStrategyMapper({
    required IriTermMapper<lib84483435.ClassWithIriMapperInstanceStrategy> iriMapper
  }) : _iriMapper = iriMapper;
