...
// Generated on: 2025-06-07T11:27:43.358912
...
class BookMapper implements GlobalResourceMapper<Book> {
  ...
  @override
  IriTerm get typeIri => IriTerm('https://schema.org/Book');
  ...
  Book fromRdfResource(IriTerm subject, DeserializationContext context) {
    ...
    final title = reader.require<String>(IriTerm('https://schema.org/name'));

    final authorId = reader.require<String>(IriTerm('https://schema.org/author'));
...
class ClassWithEmptyIriStrategyMapper implements GlobalResourceMapper<ClassWithEmptyIriStrategy> {
  ...
  @override
  IriTerm get typeIri => IriTerm('https://schema.org/Person');
