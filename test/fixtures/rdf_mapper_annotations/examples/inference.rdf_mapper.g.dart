...
// Source: test/fixtures/rdf_mapper_annotations/examples/inference.dart
...
class TestGlobalResourceMapper
  ...
  static final RegExp _regex =
      RegExp('^http://example\.org/global/(?<id>[^/]*)\$');
...
class InferenceTestContainerMapper
  ...
  InferenceTestContainer fromRdfResource(
    ...
    final TestIri? iri =
        reader.optional(SchemaBook.identifier, iriTermDeserializer: _iriMapper);

    return InferenceTestContainer(
        globalResource: globalResource, localResource: localResource, iri: iri);
  }
  ...
  (BlankNodeTerm, List<Triple>) toRdfResource(
    ...
    return context
        ...
        .when(
            ...
            (b) => b.addValue(SchemaBook.author, resource.globalResource,
                resourceSerializer: _globalResourceMapper))
        .when(
            resource.localResource != null,
            (b) => b.addValue(SchemaBook.publisher, resource.localResource,
                resourceSerializer: _localResourceMapper))
        .when(
            resource.iri != null,
            (b) => b.addValue(SchemaBook.identifier, resource.iri,
